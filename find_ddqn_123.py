...
def train_stage(
    ...
    OBELIX, args,
    difficulty, box_speed, episodes, eps_start, eps_end,
    eps_decay_steps, warmup, stage_name, steps_offset=0
):
    steps = steps_offset
...
def main():
    ...
    ap.add_argument("--out",            default="find_ddqn_123.pth")
    ...
    ap.add_argument("--ep_stage1",      type=int,   default=2000)
    ap.add_argument("--ep_stage2",      type=int,   default=1500)
    ap.add_argument("--ep_stage3",      type=int,   default=1500)
    ...
    steps = train_stage(
        ...
        eps_decay_steps=int(args.ep_stage1 * args.max_steps * 0.75),
        warmup=2000,
    ...
    steps = train_stage(
        ...
        eps_decay_steps=int(args.ep_stage2 * args.max_steps * 0.75),
        warmup=2000,
    ...
    train_stage(
        ...
        eps_decay_steps=int(args.ep_stage3 * args.max_steps * 0.75),
        warmup=2000,
